...
data class SongResultResponseModel(
    val trackId: String, val trackName: String, val trackTimeMillis: Long, val trackPrice: Float, val currency: String,
    val artistName: String, val previewUrl: String, val collectionName: String, val artworkUrl100: String,
    val releaseDate: Date, val primaryGenreName: String
)